...
namespace Fuar
{
  public class RaporlarPivot : XtraForm
  {
    ...
    public RaporlarPivot() => this.InitializeComponent();
    ...
    private void btn_excel_Click(object sender, EventArgs e)
    {
      ...
      if (this.sdialog.ShowDialog() != DialogResult.OK)
        return;
      this.dtg_rapor.ExportToXls(this.sdialog.FileName);
    }
    ...
    private void btn_yazdir_Click(object sender, EventArgs e) => this.dtg_rapor.ShowPrintPreview();
    ...
    {
      this.cmb_raporlar.Properties.DataSource = (object) _main.komutcalistir_dt("SELECT ID,REPORTNAME,REPORTINFO FROM RAPORLAR WHERE REPORTTYPE = 'Pivot Rapor'");
    ...
    private void InitializeComponent()
    {
      ...
      this.dtg_rapor.Location = new Point(1, (int) sbyte.MaxValue);
      ...
      this.dtg_rapor.Size = new Size(1268, 509);
      this.dtg_rapor.TabIndex = 77;
      ...
      this.Name = nameof (RaporlarPivot);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.Text = "Pivot Raporlar";
