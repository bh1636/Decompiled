...
namespace Fuar
{
  public class Raporlar : XtraForm
  {
    private string str_path = string.Empty;
    private IContainer components;
    private GridControl dtg_rapor;
    private GridView grd_rapor;
    ...
    public Raporlar() => this.InitializeComponent();
    ...
    private void btn_excel_Click(object sender, EventArgs e)
    {
      ...
      if (this.sdialog.ShowDialog() != DialogResult.OK)
        return;
      this.grd_rapor.ExportToXls(this.sdialog.FileName);
    }
    ...
    private void btn_pdf_Click(object sender, EventArgs e)
    {
      ...
      printableComponentLink.Component = (IPrintable) this.dtg_rapor;
      ...
      ps.ExportToPdf(this.sdialog.FileName);
      this.Cursor = Cursors.Default;
      ps.Dispose();
      printableComponentLink.Dispose();
    }

    private void btn_yazdir_Click(object sender, EventArgs e) => this.PrintPreview(this.dtg_rapor);
    ...
    {
      this.cmb_raporlar.Properties.DataSource = (object) _main.komutcalistir_dt("SELECT ID,REPORTNAME,REPORTINFO FROM RAPORLAR WHERE REPORTTYPE = 'Tablo Rapor'");
    ...
    {
      if (this.grd_rapor.FocusedValue != null)
        Clipboard.SetText(this.grd_rapor.FocusedValue.ToString());
      else
        Clipboard.Clear();
    }
    ...
    {
      if (e.Button != MouseButtons.Right || !this.grd_rapor.CalcHitInfo(e.Location).InRow)
        return;
      this.pp2.ShowPopup(Control.MousePosition);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.dtg_rapor = new GridControl();
      this.grd_rapor = new GridView();
      ...
      this.SuspendLayout();
      this.dtg_rapor.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      this.dtg_rapor.Location = new Point(0, 118);
      this.dtg_rapor.MainView = (BaseView) this.grd_rapor;
      this.dtg_rapor.Name = "dtg_rapor";
      this.dtg_rapor.Size = new Size(1270, 512);
      this.dtg_rapor.TabIndex = 0;
      this.dtg_rapor.ViewCollection.AddRange(new BaseView[1]
      {
        (BaseView) this.grd_rapor
      });
      this.dtg_rapor.MouseUp += new MouseEventHandler(this.dtg_rapor_MouseUp);
      this.grd_rapor.GridControl = this.dtg_rapor;
      this.grd_rapor.GroupPanelText = "Gruplamak için sütunları buraya sürükleyin...";
      this.grd_rapor.Name = "grd_rapor";
      this.grd_rapor.OptionsBehavior.Editable = false;
      this.grd_rapor.OptionsBehavior.ReadOnly = true;
      this.grd_rapor.OptionsBehavior.SummariesIgnoreNullValues = true;
      this.grd_rapor.OptionsView.HeaderFilterButtonShowMode = FilterButtonShowMode.Button;
      this.grd_rapor.OptionsView.ShowAutoFilterRow = true;
      this.grd_rapor.OptionsView.ShowFooter = true;
      ...
      this.btn_kapat.Location = new Point(1109, 646);
      ...
      this.groupControl1.Location = new Point(39, 12);
      ...
      this.barDockControl4.Location = new Point(1270, 0);
      ...
      this.vg_param.Size = new Size(260, 77);
      ...
      this.groupControl2.Location = new Point(700, 12);
      this.groupControl2.Name = "groupControl2";
      this.groupControl2.Size = new Size(264, 100);
      this.groupControl2.TabIndex = 72;
      this.groupControl2.Text = "Rapor Parametreleri";
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(1270, 695);
